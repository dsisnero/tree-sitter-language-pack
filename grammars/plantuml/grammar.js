...
module.exports = grammar({
  ...
  conflicts : ($) => [
                ...
                // NOTE: style block is conflicts with uniqkey, also use "<" and
                // ">" and "/"
                [ $.block_style, $.uniqkey ],
                // NOTE: it is because $
                [ $.message, $.uniquevar ],
  ...
  rules : {
    plantuml : ($) => choice($.baseuml, $.gannttuml, $.saltuml, $.mindmapuml,
                             $.yamluml, $.jsonuml),
             ...yamluml,
             ...baseuml,
             ...jsonuml,
