...
Pre-compiled tree-sitter grammars for 371 programming languages, with on-demand download and caching. Polyglot core that powers every binding in the xberg.io ecosystem.
