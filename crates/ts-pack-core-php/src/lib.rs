...
impl TreeSitterLanguagePackApi {
    ...
    #[cfg(any(
        any(feature = "download", not(feature = "download")),
        not(any(feature = "download", not(feature = "download")))
    ))]
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("tree_sitter_language_pack", "1.13.7")
