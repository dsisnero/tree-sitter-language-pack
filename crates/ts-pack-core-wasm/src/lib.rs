...
impl Default for WasmDataAttribute {
    fn default() -> Self {
...
impl Default for WasmProcessResult {
    fn default() -> Self {
...
impl Default for WasmFileMetrics {
    fn default() -> Self {
...
impl Default for WasmStructureItem {
    fn default() -> Self {
...
impl Default for WasmCommentInfo {
    fn default() -> Self {
...
impl Default for WasmDocstringInfo {
    fn default() -> Self {
...
impl Default for WasmDocSection {
    fn default() -> Self {
...
impl Default for WasmImportInfo {
    fn default() -> Self {
...
impl Default for WasmExportInfo {
    fn default() -> Self {
...
impl Default for WasmSymbolInfo {
    fn default() -> Self {
...
impl Default for WasmDiagnostic {
    fn default() -> Self {
...
impl Default for WasmCodeChunk {
    fn default() -> Self {
...
impl Default for WasmChunkContext {
    fn default() -> Self {
...
impl Default for WasmPackConfig {
    fn default() -> Self {
...
impl WasmByteRange {
    ...
    pub fn new(start: usize, end: usize) -> WasmByteRange {
        WasmByteRange { start: start, end: end }
    }
...
impl Default for WasmProcessConfig {
    fn default() -> Self {
...
///
/// # Example
#[wasm_bindgen(js_name = "getIndentsQuery")]
...
///
/// # Example
#[wasm_bindgen(js_name = "getFoldsQuery")]
...
#[allow(clippy::missing_errors_doc)]
#[wasm_bindgen]
pub fn prefetch(languages: Vec<String>) -> Result<(), JsValue> {
    let languages_refs: Vec<&str> = languages.iter().map(|s| s.as_str()).collect();
    tree_sitter_language_pack::prefetch(&languages_refs).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(())
}
