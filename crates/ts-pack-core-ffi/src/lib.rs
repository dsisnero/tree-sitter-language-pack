...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_attribute_from_json(
    json: *const c_char,
) -> *mut tree_sitter_language_pack::DataAttribute {
    clear_last_error();
    if json.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_attribute_to_json(
    ptr: *const tree_sitter_language_pack::DataAttribute,
) -> *mut c_char {
    clear_last_error();
    if ptr.is_null() {
...
/// Pointer must have been returned by this library, or be null.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_attribute_free(ptr: *mut tree_sitter_language_pack::DataAttribute) {
    if !ptr.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_attribute_name(
    ptr: *const tree_sitter_language_pack::DataAttribute,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_attribute_value(
    ptr: *const tree_sitter_language_pack::DataAttribute,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_attribute_span(
    ptr: *const tree_sitter_language_pack::DataAttribute,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_node_from_json(json: *const c_char) -> *mut tree_sitter_language_pack::DataNode {
    clear_last_error();
    if json.is_null() {
        set_last_error(1, "Null pointer passed for JSON string");
        return std::ptr::null_mut();
...
/// The returned string must be freed with `ts_pack_free_string`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_node_to_json(ptr: *const tree_sitter_language_pack::DataNode) -> *mut c_char {
    clear_last_error();
    if ptr.is_null() {
        set_last_error(1, "Null pointer passed to to_json");
        return std::ptr::null_mut();
...
/// Pointer must have been returned by this library, or be null.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_node_free(ptr: *mut tree_sitter_language_pack::DataNode) {
    if !ptr.is_null() {
        // SAFETY: ptr was allocated by Box::into_raw; caller ensures no aliases.
        unsafe {
            drop(Box::from_raw(ptr));
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_node_kind(
    ptr: *const tree_sitter_language_pack::DataNode,
) -> *mut tree_sitter_language_pack::DataNodeKind {
    if ptr.is_null() {
        return std::ptr::null_mut();
    }
    // SAFETY: null check above guarantees ptr is a valid pointer.
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_node_key(
    ptr: *const tree_sitter_language_pack::DataNode,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_node_value(
    ptr: *const tree_sitter_language_pack::DataNode,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_node_attributes(
    ptr: *const tree_sitter_language_pack::DataNode,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_node_children(
    ptr: *const tree_sitter_language_pack::DataNode,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_node_span(
    ptr: *const tree_sitter_language_pack::DataNode,
) -> *mut tree_sitter_language_pack::Span {
    if ptr.is_null() {
        return std::ptr::null_mut();
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_process_result_data(
    ptr: *const tree_sitter_language_pack::ProcessResult,
) -> *mut tree_sitter_language_pack::DataNode {
    if ptr.is_null() {
        return std::ptr::null_mut();
    }
    // SAFETY: null check above guarantees ptr is a valid pointer.
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_process_config_language(
    ptr: *const tree_sitter_language_pack::ProcessConfig,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_process_config_data_extraction(
    ptr: *const tree_sitter_language_pack::ProcessConfig,
) -> i32 {
    if ptr.is_null() {
        return 0;
...
/// freed with the appropriate free function.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_process_config_with_data_extraction(
    this: *mut tree_sitter_language_pack::ProcessConfig,
    enabled: i32,
) -> *mut tree_sitter_language_pack::ProcessConfig {
    clear_last_error();
...
/// freed with the appropriate free function.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_language_registry_has_parser(
    this: *const tree_sitter_language_pack::LanguageRegistry,
    name: *const std::ffi::c_char,
) -> i32 {
    clear_last_error();
...
/// Pointer must have been returned by this library, or be null.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_node_kind_free(ptr: *mut tree_sitter_language_pack::DataNodeKind) {
    if !ptr.is_null() {
        // SAFETY: ptr was allocated by Box::into_raw; caller ensures no aliases.
        unsafe {
            drop(Box::from_raw(ptr));
...
/// The returned string must be freed with `ts_pack_free_string`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_node_kind_to_json(
    ptr: *const tree_sitter_language_pack::DataNodeKind,
) -> *mut c_char {
    if ptr.is_null() {
        set_last_error(1, "Null pointer passed to ts_pack_data_node_kind_to_json");
        return std::ptr::null_mut();
    }
...
/// The returned string must be freed with `ts_pack_free_string`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_data_node_kind_to_string(
    ptr: *const tree_sitter_language_pack::DataNodeKind,
) -> *mut c_char {
    if ptr.is_null() {
        set_last_error(1, "Null pointer passed to ts_pack_data_node_kind_to_string");
        return std::ptr::null_mut();
    }
    // SAFETY: null check above guarantees ptr is valid; no mutable aliases held.
    let val = unsafe { &*ptr };
...
pub unsafe extern "C" fn ts_pack_get_language(name: *const std::ffi::c_char) -> *const tree_sitter::ffi::TSLanguage {
    ...
    match result {
        Ok(val) => val.into_raw() as *const tree_sitter::ffi::TSLanguage,
        Err(e) => {
            set_last_error(2, &e.to_string());
            std::ptr::null()
        }
...
pub unsafe extern "C" fn ts_pack_prefetch(languages: *const std::ffi::c_char) -> i32 {
    ...
    let result = tree_sitter_language_pack::prefetch(&languages_rs.iter().map(|s| s.as_str()).collect::<Vec<&str>>());
    match result {
        Ok(()) => 0,
        Err(e) => {
            set_last_error(2, &e.to_string());
