...
private class SymbolKindDeserializer : com.fasterxml.jackson.databind.deser.std.StdDeserializer<SymbolKind>(SymbolKind::class.java) {
    ...
    override fun deserialize(
        ...
        if (node.isTextual) {
            return when (node.asText()) {
                ...
                "Module" -> SymbolKind.Module
                    ...
                    parser, "Unknown SymbolKind unit variant", node.asText(), SymbolKind::class.java,
                )
            }
        }
        if (node.isObject) {
            ...
            if (it.hasNext()) {
                ...
                if (!it.hasNext()) {
                    ...
                    return when (entry.key) {
                        "Other" -> SymbolKind.Other(ctx.readTreeAsValue<String>(payload, String::class.java))
                        else -> throw com.fasterxml.jackson.databind.exc.InvalidFormatException(
                            parser, "Unknown SymbolKind data variant", entry.key, SymbolKind::class.java,
                        )
                    }
                }
            }
        ...
        throw com.fasterxml.jackson.databind.exc.InvalidFormatException(
            parser, "Cannot deserialize SymbolKind: expected string or single-field object", null, SymbolKind::class.java,
        )
    }
}

private class SymbolKindSerializer : com.fasterxml.jackson.databind.set.std.StdSerializer<SymbolKind>(SymbolKind::class.java) {
    @Suppress("LongMethod")
