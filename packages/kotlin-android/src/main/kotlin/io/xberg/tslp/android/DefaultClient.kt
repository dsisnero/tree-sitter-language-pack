...
class Parser internal constructor(internal val handle: Long) : AutoCloseable {
    ...
    fun parse(source: String): Tree? {
        val handle = TreeSitterLanguagePackBridge.nativeParserParse(handle, MAPPER.writeValueAsString(source))
...
class Node internal constructor(internal val handle: Long) : AutoCloseable {
    ...
    fun child(index: Int): Node? {
        val handle = TreeSitterLanguagePackBridge.nativeNodeChild(handle, MAPPER.writeValueAsString(index))
        return if (handle == 0L) null else Node(handle)
    }
    ...
    fun namedChild(index: Int): Node? {
        val handle = TreeSitterLanguagePackBridge.nativeNodeNamedChild(handle, MAPPER.writeValueAsString(index))
        return if (handle == 0L) null else Node(handle)
    }
    ...
    fun childByFieldName(name: String): Node? {
        val handle = TreeSitterLanguagePackBridge.nativeNodeChildByFieldName(handle, MAPPER.writeValueAsString(name))
        return if (handle == 0L) null else Node(handle)
    }
...
class LanguageRegistry internal constructor(internal val handle: Long) : AutoCloseable {
    ...
    fun getLanguage(name: String): Language {
        val handle = TreeSitterLanguagePackBridge.nativeLanguageRegistryGetLanguage(handle, MAPPER.writeValueAsString(name))
