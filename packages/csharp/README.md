...
Pre-compiled tree-sitter grammars for 371 programming languages with C# bindings via P/Invoke.
...
See the [language guide](https://docs.tree-sitter-language-pack.xberg.io) for `csharp`-specific usage.
