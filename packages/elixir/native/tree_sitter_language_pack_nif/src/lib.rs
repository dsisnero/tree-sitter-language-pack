...
impl DataNode {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            key: opts.get("key").and_then(|t| t.decode().ok()),
            value: opts.get("value").and_then(|t| t.decode().ok()),
...
#[derive(Clone)]
pub struct Parser {
    inner: Arc<std::sync::RwLock<tree_sitter_language_pack::Parser>>,
}
...
#[derive(Clone)]
pub struct Tree {
    inner: Arc<std::sync::RwLock<tree_sitter_language_pack::Tree>>,
}
...
#[derive(Clone)]
pub struct Node {
    inner: Arc<std::sync::RwLock<tree_sitter_language_pack::Node>>,
}
...
pub struct TreeCursor {
    inner: Arc<std::sync::RwLock<tree_sitter_language_pack::TreeCursor>>,
}
...
pub struct LanguageRegistry {
    inner: Arc<std::sync::RwLock<tree_sitter_language_pack::LanguageRegistry>>,
}
...
pub struct DownloadManager {
    inner: Arc<std::sync::RwLock<tree_sitter_language_pack::DownloadManager>>,
}
...
#[derive(Clone)]
pub struct Language {
    inner: Arc<std::sync::RwLock<tree_sitter_language_pack::Language>>,
}
...
pub fn get_indents_query(language: String) -> Option<String> {
    tree_sitter_language_pack::get_indents_query(&language).map(|v| v.into())
}
...
pub fn get_folds_query(language: String) -> Option<String> {
    tree_sitter_language_pack::get_folds_query(&language).map(|v| v.into())
}
...
pub fn prefetch(languages: Vec<String>) -> Result<(), String> {
    ...
    let result = tree_sitter_language_pack::prefetch(&languages_refs).map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn parser_new() -> ResourceArc<Parser> {
    ResourceArc::new(Parser {
        inner: Arc::new(std::sync::RwLock::new(tree_sitter_language_pack::Parser::new())),
    })
}
...
pub fn parser_reset(resource: rustler::ResourceArc<Parser>) -> () {
    resource.inner.write().unwrap_or_else(|e| e.into_inner()).reset()
}

#[rustler::nif]
pub fn parser_default() -> ResourceArc<Parser> {
    ResourceArc::new(Parser {
        inner: Arc::new(std::sync::RwLock::new(tree_sitter_language_pack::Parser::default())),
    })
}
...
pub fn tree_root_node(resource: rustler::ResourceArc<Tree>) -> ResourceArc<Node> {
    ResourceArc::new(Node {
        inner: Arc::new(std::sync::RwLock::new(
            resource.inner.read().unwrap_or_else(|e| e.into_inner()).root_node(),
        )),
    })
}
...
pub fn tree_walk(resource: rustler::ResourceArc<Tree>) -> ResourceArc<TreeCursor> {
    ResourceArc::new(TreeCursor {
        inner: Arc::new(std::sync::RwLock::new(
            resource.inner.read().unwrap_or_else(|e| e.into_inner()).walk(),
        )),
    })
}
...
pub fn node_kind(resource: rustler::ResourceArc<Node>) -> String {
    resource.inner.read().unwrap_or_else(|e| e.into_inner()).kind()
}
...
pub fn node_kind_id(resource: rustler::ResourceArc<Node>) -> u16 {
    resource.inner.read().unwrap_or_else(|e| e.into_inner()).kind_id()
}

/// Return the inclusive start byte offset of this node.
#[rustler::nif]
pub fn node_start_byte(resource: rustler::ResourceArc<Node>) -> usize {
    resource.inner.read().unwrap_or_else(|e| e.into_inner()).start_byte()
}

/// Return the exclusive end byte offset of this node.
#[rustler::nif]
pub fn node_end_byte(resource: rustler::ResourceArc<Node>) -> usize {
    resource.inner.read().unwrap_or_else(|e| e.into_inner()).end_byte()
}
...
pub fn node_is_named(resource: rustler::ResourceArc<Node>) -> bool {
    resource.inner.read().unwrap_or_else(|e| e.into_inner()).is_named()
}

/// True when this is an error node.
#[rustler::nif]
pub fn node_is_error(resource: rustler::ResourceArc<Node>) -> bool {
    resource.inner.read().unwrap_or_else(|e| e.into_inner()).is_error()
}

/// True when this is a missing-token node.
#[rustler::nif]
pub fn node_is_missing(resource: rustler::ResourceArc<Node>) -> bool {
    resource.inner.read().unwrap_or_else(|e| e.into_inner()).is_missing()
}

/// True when this is an "extra" node (e.g. a comment).
#[rustler::nif]
pub fn node_is_extra(resource: rustler::ResourceArc<Node>) -> bool {
    resource.inner.read().unwrap_or_else(|e| e.into_inner()).is_extra()
}

/// True when this node or any descendant is an error.
#[rustler::nif]
pub fn node_has_error(resource: rustler::ResourceArc<Node>) -> bool {
    resource.inner.read().unwrap_or_else(|e| e.into_inner()).has_error()
}
...
pub fn node_child_count(resource: rustler::ResourceArc<Node>) -> usize {
    resource.inner.read().unwrap_or_else(|e| e.into_inner()).child_count()
}
...
pub fn node_to_sexp(resource: rustler::ResourceArc<Node>) -> String {
    resource.inner.read().unwrap_or_else(|e| e.into_inner()).to_sexp()
}
...
pub fn treecursor_node(resource: rustler::ResourceArc<TreeCursor>) -> ResourceArc<Node> {
    ResourceArc::new(Node {
        inner: Arc::new(std::sync::RwLock::new(
            resource.inner.read().unwrap_or_else(|e| e.into_inner()).node(),
        )),
    })
}
...
pub fn treecursor_goto_parent(resource: rustler::ResourceArc<TreeCursor>) -> bool {
    resource.inner.write().unwrap_or_else(|e| e.into_inner()).goto_parent()
}
...
pub fn treecursor_field_name(resource: rustler::ResourceArc<TreeCursor>) -> Option<String> {
    resource.inner.read().unwrap_or_else(|e| e.into_inner()).field_name()
}
...
#[rustler::nif]
pub fn processconfig_with_data_extraction(obj: ProcessConfig, enabled: bool) -> ProcessConfig {
    tree_sitter_language_pack::ProcessConfig::from(obj)
...
pub fn languageregistry_new() -> ResourceArc<LanguageRegistry> {
    ResourceArc::new(LanguageRegistry {
        inner: Arc::new(std::sync::RwLock::new(
            tree_sitter_language_pack::LanguageRegistry::new(),
        )),
    })
}
...
pub fn languageregistry_default() -> ResourceArc<LanguageRegistry> {
    ResourceArc::new(LanguageRegistry {
        inner: Arc::new(std::sync::RwLock::new(
            tree_sitter_language_pack::LanguageRegistry::default(),
        )),
    })
}
...
impl From<StructureKind> for tree_sitter_language_pack::StructureKind {
    fn from(val: StructureKind) -> Self {
        match val.format_type.as_str() {
            ...
            "Other" => tree_sitter_language_pack::StructureKind::Other(val.other.unwrap_or_default()),
            _ => Default::default(),
        }
    }
}
...
impl From<DocstringFormat> for tree_sitter_language_pack::DocstringFormat {
    fn from(val: DocstringFormat) -> Self {
        match val.format_type.as_str() {
            ...
            "Other" => tree_sitter_language_pack::DocstringFormat::Other(val.other.unwrap_or_default()),
            _ => Default::default(),
        }
    }
}
...
impl From<SymbolKind> for tree_sitter_language_pack::SymbolKind {
    fn from(val: SymbolKind) -> Self {
        match val.format_type.as_str() {
            ...
            "Other" => tree_sitter_language_pack::SymbolKind::Other(val.other.unwrap_or_default()),
            _ => Default::default(),
        }
    }
}
