...
module TreeSitterLanguagePack
  ...
  class StructureItem
    ...
    getter kind : StructureKind = StructureKind::Function.new
  ...
  class DocstringInfo
    ...
    getter format : DocstringFormat = DocstringFormat::PythonTripleQuote.new
  ...
  class SymbolInfo
    ...
    getter kind : SymbolKind = SymbolKind::Variable.new
  ...
  class Parser
    ...
    LibTsPack.parser_set_language(@handle, name)
  ...
  class Node
    ...
    if __ptr.null?
      __ctx_ptr = LibTsPack.last_error_context
      raise String.new(__ctx_ptr) unless __ctx_ptr.null?
      raise "LibTsPack.node_byte_range returned a null pointer"
    end
    ...
    if __ptr.null?
      __ctx_ptr = LibTsPack.last_error_context
      raise String.new(__ctx_ptr) unless __ctx_ptr.null?
      raise "LibTsPack.node_start_position returned a null pointer"
    end
    ...
    if __ptr.null?
      __ctx_ptr = LibTsPack.last_error_context
      raise String.new(__ctx_ptr) unless __ctx_ptr.null?
      raise "LibTsPack.node_end_position returned a null pointer"
    end
    __json_ptr = LibTsPack.point_to_json(__ptr)
    LibTsPack.point_free(__ptr)
    __json = String.new(__json_ptr)
  ...
  class LanguageRegistry
    ...
    __result = begin
          ...
          if __ptr.null?
            __ctx_ptr = LibTsPack.last_error_context
            raise String.new(__ctx_ptr) unless __ctx_ptr.null?
            raise "LibTsPack.language_registry_process returned a null pointer"
          end
  ...
  class DownloadManager
    ...
    def clean_cache() : Nil
    LibTsPack.download_manager_clean_cache(@handle)
    __code = LibTsPack.last_error_code
    if __code != 0
      __ctx_ptr = LibTsPack.last_error_context
      raise String.new(__ctx_ptr) unless __ctx_ptr.null?
  ...
  def self.process(source : String, config : ProcessConfig) : ProcessResult
    ...
    if __ptr.null?
      __ctx_ptr = LibTsPack.last_error_context
      raise String.new(__ctx_ptr) unless __ctx_ptr.null?
      raise "LibTsPack.process returned a null pointer"
    end
    __json_ptr = LibTsPack.process_result_to_json(__ptr)
    LibTsPack.process_result_free(__ptr)
    __json = String.new(__json_ptr)
  ...
  def self.init(config : PackConfig) : Nil
    ...
    LibTsPack.init(__handle_config)
    __code = LibTsPack.last_error_code
    if __code != 0
      __ctx_ptr = LibTsPack.last_error_context
      raise String.new(__ctx_ptr) unless __ctx_ptr.null?
  ...
  def self.configure(config : PackConfig) : Nil
    __handle_config = LibTsPack.pack_config_from_json(config.to_json)
    LibTsPack.configure(__handle_config)
    __code = LibTsPack.last_error_code
    if __code != 0
      __ctx_ptr = LibTsPack.last_error_context
      raise String.new(__ctx_ptr) unless __ctx_ptr.null?
  ...
  def self.prefetch(languages : Array(String)) : Nil
    LibTsPack.prefetch(languages.to_json)
    __code = LibTsPack.last_error_code
    if __code != 0
      __ctx_ptr = LibTsPack.last_error_context
      raise String.new(__ctx_ptr) unless __ctx_ptr.null?
