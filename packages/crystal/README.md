...
Crystal bindings for **tree-sitter-language-pack** — 306 pre-compiled tree-sitter
grammars with on-demand download and caching. Crystal API over the C FFI with
`#` doc comments and `JSON::Serializable` config types.
