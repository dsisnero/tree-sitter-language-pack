...
Pre-compiled tree-sitter grammars for 371 programming languages with idiomatic Go bindings via cgo.
...
See the [language guide](https://docs.tree-sitter-language-pack.xberg.io) for `go`-specific usage.
