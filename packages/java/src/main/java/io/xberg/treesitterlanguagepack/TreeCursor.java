...
public class TreeCursor implements AutoCloseable {
    ...
    public boolean gotoFirstChild() throws TreeSitterLanguagePackRsException {
        try {
            var result = (long) NativeLib.TS_PACK_TREE_CURSOR_GOTO_FIRST_CHILD.invoke(this.handle);
            return result != 0;
        } catch (TreeSitterLanguagePackRsException ex) {
            throw ex;
        } catch (Throwable e) {
    ...
    public boolean gotoParent() throws TreeSitterLanguagePackRsException {
        try {
            var result = (long) NativeLib.TS_PACK_TREE_CURSOR_GOTO_PARENT.invoke(this.handle);
            return result != 0;
        } catch (TreeSitterLanguagePackRsException ex) {
            throw ex;
        } catch (Throwable e) {
    ...
    public boolean gotoNextSibling() throws TreeSitterLanguagePackRsException {
        try {
            var result = (long) NativeLib.TS_PACK_TREE_CURSOR_GOTO_NEXT_SIBLING.invoke(this.handle);
            return result != 0;
        } catch (TreeSitterLanguagePackRsException ex) {
            throw ex;
        } catch (Throwable e) {
