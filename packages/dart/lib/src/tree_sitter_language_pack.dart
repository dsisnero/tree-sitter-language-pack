...
class TreeSitterLanguagePackBridge {
  ...
  /// assert!(missing.is_none());
  /// ```
  static Future<String?> getIndentsQuery(String language) async {
    return await rust_bridge.getIndentsQuery(language: language);
  }
  ...
  /// assert!(missing.is_none());
  /// ```
  static Future<String?> getFoldsQuery(String language) async {
    return await rust_bridge.getFoldsQuery(language: language);
  }
  ...
  /// ```
  /// throws Error on failure
  static Future<void> prefetch(List<String> languages) async {
    return await rust_bridge.prefetch(languages: languages);
  }
