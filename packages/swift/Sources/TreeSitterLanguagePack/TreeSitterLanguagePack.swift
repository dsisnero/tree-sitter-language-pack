...
public struct ProcessConfig: Codable, Sendable, Hashable {
    ...
    public func withChunking(max_size: UInt) -> ProcessConfig {
        fatalError("Not yet implemented: process_config_with_chunking")
    }

    public func all() -> ProcessConfig {
        fatalError("Not yet implemented: process_config_all")
    }

    public func minimal() -> ProcessConfig {
        fatalError("Not yet implemented: process_config_minimal")
    }

    public func withDataExtraction(enabled: Bool) -> ProcessConfig {
        fatalError("Not yet implemented: process_config_with_data_extraction")
    }
