...
/// }
/// ```
public typealias DataNode = RustBridge.DataNode
...
public struct ProcessConfig: Codable, Sendable, Hashable {
    ...
    public init(language: String, structure: Bool, imports: Bool, exports: Bool, comments: Bool, docstrings: Bool, symbols: Bool, diagnostics: Bool, chunkMaxSize: UInt? = nil, dataExtraction: Bool) {
        self.language = language
...
internal extension ProcessConfig {
    ...
    func intoRust() throws -> RustBridge.ProcessConfig {
        return RustBridge.ProcessConfig(RustString(self.language), self.structure, self.imports, self.exports, self.comments, self.docstrings, self.symbols, self.diagnostics, self.chunkMaxSize, self.dataExtraction)
    }
}
...
public func dataNodeFromJson(_ json: String) throws -> DataNode {
    return try RustBridge.dataNodeFromJson(json)
}
