...
#[used]
static __ALEF_KEEP_FFI_LINKED: unsafe extern "C" fn() -> *const ::std::ffi::c_char = ts_pack_core_ffi::ts_pack_version;
...
mod ffi {
    extern "Rust" {
        type DataAttribute;
        #[swift_bridge(init)]
        fn new(name: String, value: String, span: Span) -> DataAttribute;
        fn name(&self) -> String;
    ...
    extern "Rust" {
        ...
        fn parsed_sections(&self) -> Vec<String>;
    }
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "processConfigWithChunkingFromJson")]
        fn process_config_with_chunking_from_json(json: String, max_size: usize) -> Result<String, String>;
        #[swift_bridge(swift_name = "processConfigAllFromJson")]
        fn process_config_all_from_json(json: String) -> Result<String, String>;
        #[swift_bridge(swift_name = "processConfigMinimalFromJson")]
        fn process_config_minimal_from_json(json: String) -> Result<String, String>;
        #[swift_bridge(swift_name = "processConfigWithDataExtractionFromJson")]
        fn process_config_with_data_extraction_from_json(json: String, enabled: bool) -> Result<String, String>;
    }
    ...
    extern "Rust" {
        type Language;
        fn language_noop(client: &Language);
        ...
        #[swift_bridge(swift_name = "getTagsQuery")]
        fn get_tags_query(language: String) -> String;
        #[swift_bridge(swift_name = "getIndentsQuery")]
        fn get_indents_query(language: String) -> String;
        #[swift_bridge(swift_name = "getFoldsQuery")]
        fn get_folds_query(language: String) -> String;
        #[swift_bridge(swift_name = "getLanguage")]
        fn get_language(name: String) -> usize;
    ...
    extern "Rust" {
        fn prefetch(languages: Vec<String>) -> Result<(), String>;
    }
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "dataAttributeFromJson")]
        fn data_attribute_from_json(json: String) -> Result<DataAttribute, String>;
        #[swift_bridge(swift_name = "dataNodeFromJson")]
        fn data_node_from_json(json: String) -> Result<DataNode, String>;
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "dataNodeKindFromJson")]
        fn data_node_kind_from_json(json: String) -> Result<DataNodeKind, String>;
    ...
    extern "Rust" {
        ...
        fn __alef_phantom_vec_data_attribute() -> Vec<DataAttribute>;
        fn __alef_phantom_vec_data_node() -> Vec<DataNode>;
        ...
        fn __alef_phantom_vec_data_node_kind() -> Vec<DataNodeKind>;
...
#[doc(hidden)]
pub fn __alef_phantom_vec_data_attribute() -> Vec<DataAttribute> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_data_node() -> Vec<DataNode> {
    Vec::new()
}
#[doc(hidden)]
...
#[doc(hidden)]
pub fn __alef_phantom_vec_data_node_kind() -> Vec<DataNodeKind> {
    Vec::new()
}
#[doc(hidden)]
...
pub struct DataAttribute(pub tree_sitter_language_pack::DataAttribute);
impl DataAttribute {
    pub fn new(name: String, value: String, span: Span) -> DataAttribute {
        let mut __target: tree_sitter_language_pack::DataAttribute = ::std::default::Default::default();
        {
...
pub struct DataNode(pub tree_sitter_language_pack::DataNode);
impl DataNode {
    pub fn new(
        kind: DataNodeKind,
        key: Option<String>,
        ...
        let mut __target: tree_sitter_language_pack::DataNode = ::std::default::Default::default();
        // alef: kind (DataNodeKind) is an enum; reverse From not generated — left at default
        if let Some(s) = key {
            // Try JSON parse first (handles enum/object values); on parse failure
            // treat the raw input as a JSON string scalar so plain `String` /
            // string-like enum fields don't end up empty for inputs that aren't
        ...
        if let Some(s) = value {
            ...
            let __v = ::serde_json::from_str::<::serde_json::Value>(&s).unwrap_or(::serde_json::Value::String(s));
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.value = Some(t);
            }
        }
        __target.attributes = attributes.into_iter().map(|w| w.0).collect();
        __target.children = children.into_iter().map(|w| w.0).collect();
        __target.span = span.0;
        DataNode(__target)
    }
    pub fn kind(&self) -> String {
        DataNodeKind::from(self.0.kind.clone()).to_string()
    }
    ...
    pub fn attributes(&self) -> Vec<DataAttribute> {
        self.0
            .attributes
            .iter()
            .map(|elem| DataAttribute(elem.clone()))
            .collect()
    }
    pub fn children(&self) -> Vec<DataNode> {
        self.0.children.iter().map(|elem| DataNode(elem.clone())).collect()
    }
    pub fn span(&self) -> Span {
        Span(self.0.span.clone())
    }
...
impl ProcessResult {
    ...
    pub fn data(&self) -> Option<DataNode> {
        self.0.data.clone().map(DataNode)
    }
}
...
impl DocstringInfo {
    ...
    pub fn format(&self) -> String {
        serde_json::to_string(&self.0.format).unwrap_or_else(|_| "null".to_string())
    }
    pub fn span(&self) -> Span {
        Span(self.0.span.clone())
    }
...
impl ChunkContext {
    ...
    pub fn docstrings(&self) -> Vec<String> {
        self.0
            .docstrings
            .iter()
            .map(|elem| serde_json::to_string(elem).unwrap_or_else(|_| "null".to_string()))
...
pub fn process_config_with_chunking_from_json(json: String, max_size: usize) -> Result<String, String> {
    let __self: tree_sitter_language_pack::ProcessConfig =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize ProcessConfig: {}", e))?;
    let __result = __self.with_chunking(max_size);
    serde_json::to_string(&__result).map_err(|e| format!("Failed to serialize result: {}", e))
}

pub fn process_config_all_from_json(json: String) -> Result<String, String> {
    let __self: tree_sitter_language_pack::ProcessConfig =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize ProcessConfig: {}", e))?;
    let __result = __self.all();
    serde_json::to_string(&__result).map_err(|e| format!("Failed to serialize result: {}", e))
}

pub fn process_config_minimal_from_json(json: String) -> Result<String, String> {
    let __self: tree_sitter_language_pack::ProcessConfig =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize ProcessConfig: {}", e))?;
    let __result = __self.minimal();
    serde_json::to_string(&__result).map_err(|e| format!("Failed to serialize result: {}", e))
}

pub fn process_config_with_data_extraction_from_json(json: String, enabled: bool) -> Result<String, String> {
    let __self: tree_sitter_language_pack::ProcessConfig =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize ProcessConfig: {}", e))?;
    let __result = __self.with_data_extraction(enabled);
    serde_json::to_string(&__result).map_err(|e| format!("Failed to serialize result: {}", e))
}
...
pub fn language_noop(client: &Language) {
...
impl DataNodeKind {
    pub fn to_string(&self) -> String {
        match self {
            Self::KeyValue => "KeyValue".to_string(),
...
pub fn get_tags_query(language: String) -> String {
    serde_json::to_string(&(tree_sitter_language_pack::get_tags_query(&language))).expect("serializable return")
}

pub fn get_indents_query(language: String) -> String {
    serde_json::to_string(&(tree_sitter_language_pack::get_indents_query(&language))).expect("serializable return")
}

pub fn get_folds_query(language: String) -> String {
    serde_json::to_string(&(tree_sitter_language_pack::get_folds_query(&language))).expect("serializable return")
}

pub fn get_language(name: String) -> usize {
    tree_sitter_language_pack::get_language(&name)
        .map(|__cap| __cap.into_raw() as usize)
        .unwrap_or(0)
}
...
#[cfg(any(feature = "download", not(feature = "download")))]
pub fn prefetch(languages: Vec<String>) -> Result<(), String> {
    tree_sitter_language_pack::prefetch(&languages.iter().map(|s| s.as_str()).collect::<Vec<_>>())
        .map_err(|e| e.to_string())
}
...
pub fn data_attribute_from_json(json: String) -> Result<DataAttribute, String> {
    serde_json::from_str::<tree_sitter_language_pack::DataAttribute>(&json)
        .map(DataAttribute)
        .map_err(|e| e.to_string())
}
pub fn data_node_from_json(json: String) -> Result<DataNode, String> {
...
pub fn data_node_kind_from_json(json: String) -> Result<DataNodeKind, String> {
    serde_json::from_str::<tree_sitter_language_pack::DataNodeKind>(&json)
        .map(DataNodeKind::from)
        .map_err(|e| e.to_string())
}
