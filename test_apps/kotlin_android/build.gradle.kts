...
dependencies {
    ...
    implementation("io.xberg.tslp.android:tree-sitter-language-pack-android:1.13.6")
...
tasks.register("verifyAarPublished") {
    ...
    doLast {
        val aarCoord = "io.xberg.tslp.android:tree-sitter-language-pack-android:1.13.6"
