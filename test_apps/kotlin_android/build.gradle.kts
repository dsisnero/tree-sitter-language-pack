...
group = "io.xberg.tslp.android"
version = "0.1.0"

android {
    namespace = "io.xberg.tslp.android.e2e"
    compileSdk = 35
...
dependencies {
    ...
    implementation("io.xberg.tslp.android:tree-sitter-language-pack-android:1.13.4")
...
tasks.register("verifyAarPublished") {
    ...
    doLast {
        val aarCoord = "io.xberg.tslp.android:tree-sitter-language-pack-android:1.13.4"
