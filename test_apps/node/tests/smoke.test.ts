...
describe("smoke", () => {
  ...
  it("smoke_soql: Smoke test: load soql and parse a simple snippet", () => {
    process("SELECT Id FROM Account\n", { language: "soql" });
  }, 30000);
