...
- [Code intelligence](/guides/intelligence/) — the other `ProcessConfig` fields that work alongside chunking
- [Concepts: Code intelligence](/concepts/code-intelligence/) — the extraction engine design
