...
- [Code intelligence](/guides/intelligence/) — extract functions, imports, docstrings, and symbols without writing a tree walker
- [Extraction queries](/guides/extraction/) — public API status for custom query helpers
- [Languages](/languages/) — all 306 supported languages and their aliases
