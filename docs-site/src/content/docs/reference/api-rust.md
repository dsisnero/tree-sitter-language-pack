...
## Rust API Reference <span class="version-badge">v1.14.0</span>
...
```rust
pub fn get_indents_query(language: &str) -> Option<String>
```
...
```rust
pub fn get_folds_query(language: &str) -> Option<String>
```
...
```rust
pub fn prefetch(languages: Vec<String>) -> Result<(), Error>
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `languages` | `Vec<String>` | Yes | The languages |
