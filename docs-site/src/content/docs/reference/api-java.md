...
## Java API Reference <span class="version-badge">v1.13.5</span>
...
```java
public static Optional<String> getIndentsQuery(String language)
```

**Example:**

```java
var result = getIndentsQuery("value");
```
...
```java
public static Optional<String> getFoldsQuery(String language)
```

**Example:**

```java
var result = getFoldsQuery("value");
```
...
```java
public static void prefetch(List<String> languages) throws Error
```
