  ...
  integrations : [
    starlight(
        xbergStarlightConfig({
          ...
          editBaseUrl :
              "https://github.com/xberg-io/tree-sitter-language-pack/edit/main/docs-site/",
          plugins : [
            starlightLlmsTxt({
              customSets : [
                {
                ...
                },
                {
                  label : "Concepts",
                  description :
                      "Architecture, language passthrough, the download model, and code intelligence.",
                  paths : [ "concepts/**" ],
                },
                {
                  label : "Reference",
                ...
                },
                {
                  label : "More",
                  description :
                      "Contributing, CI/CD, changelog, and the Xberg ecosystem.",
                  paths : [
                    "contributing", "contributing/**", "changelog", "ecosystem"
                  ],
                },
              ],
              optionalLinks : [
