...
use tree_sitter_language_pack::{cache_dir, clean_cache, configure, download, downloaded_languages, init, prefetch};
...
fn test_prefetch_empty_list() {
    ...
    let _ = prefetch(&languages_refs).expect("should succeed");
}

#[test]
fn test_prefetch_languages() {
