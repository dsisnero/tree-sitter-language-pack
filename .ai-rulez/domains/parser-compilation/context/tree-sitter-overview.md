...
This project compiles 371 grammars into a single Rust crate with bindings for Python, Node.js, Ruby, PHP, Go, Java, JNI, C#, Elixir, WebAssembly, Dart, Kotlin Android, Swift, Zig, and C FFI.
